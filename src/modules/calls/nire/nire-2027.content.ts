...
export const nire2027Content: Record<"pt" | "en", CallPageData> = {
  pt: {
    ...
    categories: [
        { title: "Reflexões e Provocações", paragraphs: [
    ...
    format: {
      ...
      phase1Rules: ["As pessoas autoras de trabalhos de Reflexões e Provocações devem enviar um artigo com no mínimo 8 (oito) e no máximo 10 (dez) páginas, sem contar as referências.", "As seções podem ser definidas de acordo com as pessoas autoras do trabalho."],
      phase2Title: "Desenho de Pesquisa",
      phase2Rules: ["As pessoas pesquisadoras em formação, autoras de trabalhos de Desenho de Pesquisa, devem enviar artigo curto com no mínimo 4 (quatro) e no máximo 5 (cinco) páginas, sem contar as referências, juntamente com a ficha de pesquisa.", "As seções podem ser definidas de acordo com as pessoas autoras do trabalho."],
    },
    formatParagraphs: [
      ...
      ["As pessoas pesquisadoras em formação, autoras de trabalhos de Desenho de Pesquisa, devem enviar artigo curto com no mínimo 4 (quatro) e no máximo 5 (cinco) páginas, sem contar as referências, juntamente com a ", link("researchForm", "ficha de pesquisa"), ". As seções podem ser definidas de acordo com as pessoas autoras do trabalho."],
    ],
    ...
    publication: {
      paragraphs: [["A versão final, em formato PDF, deve ser submetida no sistema JEMS, considerando de modo obrigatório e cuidadosamente as recomendações dos revisores. Juntamente com a versão final, as pessoas autoras devem enviar o ", link("publicationAuthorization", "termo de autorização de publicação"), " do artigo, devidamente preenchido e assinado, via plataforma JEMS."]],
      requirements: [
    ...
    importantInfoParagraph: ["O SBSI segue o ", link("sbc", "Código de Conduta para Autores da SBC"), ", que trata do comportamento ético, honesto e responsável de pessoas autoras e foi atualizado recentemente. Na parte II, Art. 2º, temos que “o uso de Inteligência Artificial (IA) Generativa: a utilização de ferramentas e tecnologias de IA Generativa para geração de conteúdos, na escrita e/ou revisão do conteúdo de artigos, deve ser declarada explicitamente no trabalho. A declaração pode ocorrer na Seção de Agradecimentos, na metodologia ou em uma seção definida especificamente para este fim, de acordo com o template adotado, e deve listar as ferramentas e descrever onde foram empregadas, por exemplo, textos, tabelas, gráficos, citações, etc. Essas ferramentas não podem ser listadas como autores de um artigo. O uso de tais ferramentas não exime os autores da responsabilidade sobre todo o seu conteúdo, inclusive no caso de ser identificado plágio”"],
    importantInfoSubtitle: [["O SBSI segue o ", link("sbc", "Código de Conduta para Autores da SBC"), ", que trata do comportamento ético, honesto e responsável de pessoas autoras e foi atualizado recentemente. Na parte II, Art. 2º, temos que “o uso de Inteligência Artificial (IA) Generativa:"]],
    importantInfoParagraphs: [["a utilização de ferramentas e tecnologias de IA Generativa para geração de conteúdos, na escrita e/ou revisão do conteúdo de artigos, deve ser declarada explicitamente no trabalho. A declaração pode ocorrer na Seção de Agradecimentos, na metodologia ou em uma seção definida especificamente para este fim, de acordo com o template adotado, e deve listar as ferramentas e descrever onde foram empregadas, por exemplo, textos, tabelas, gráficos, citações, etc. Essas ferramentas não podem ser listadas como autores de um artigo. O uso de tais ferramentas não exime os autores da responsabilidade sobre todo o seu conteúdo, inclusive no caso de ser identificado plágio”"]],
    coordinationTitle: "Coordenação da NIRE - SBSI 2027",
    coordinationKicker: "Coordenação da trilha",
    coordinators: [
      { name: "Rita Suzana Pitangueira Maciel", institution: "UFBA · rita.suzana@ufba.br" },
      { name: "José Maria David", institution: "UFJF · jose.david@ufjf.br" },
    ],
    sideLinks: { cesi: "CESI ↗", sbc: "SBC ↗", jems: "JEMS ↗" },
    tocTitle: "NESTA CHAMADA",
    toc: [
      { id: "descricao", title: "Descrição" }, { id: "topicos", title: "Tópicos" }, { id: "datas", title: "Datas" },
      { id: "categorias", title: "Categorias da Trilha" }, { id: "submissoes", title: "Submissões" },
      { id: "formato", title: "Formato da submissão" }, { id: "revisao", title: "Revisão dos Artigos" },
      { id: "publicacao", title: "Trabalhos aceitos" }, { id: "orientacao-adicional", title: "Orientação adicional" },
  ...
  en: {
    ...
    dates: [
      ["Dec 11, 2026", "Paper registration", "Deadline to register the paper in JEMS3"],
      ["Feb 18, 2027", "File submission", "Deadline to submit the paper files in JEMS3"],
    ...
    review: {
      paragraphs: [["Submissions will be selected according to the NIRE categories through review by members of the SBSI 2027 NIRE Program Committee. Each paper will be reviewed by at least three Program Committee members. All categories use a double-anonymous review process."]],
      criteria: [],
    },
    ...
    toc: [
      { id: "descricao", title: "Description" }, { id: "topicos", title: "Topics" }, { id: "datas", title: "Dates" },
      { id: "categorias", title: "Track Categories" }, { id: "submissoes", title: "Submissions" },
      { id: "formato", title: "Submission format" }, { id: "revisao", title: "Paper Review" },
      { id: "publicacao", title: "Accepted Papers" }, { id: "orientacao-adicional", title: "Additional Guidance" },
